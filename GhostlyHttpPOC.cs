...
/// <summary>
/// Storage file object from Supabase with DateTime fix
/// </summary>
public class StorageFile
{
    ...
    // Compatibility property for existing code (ignored by JSON serializer)
    [JsonIgnore]
...
public class GhostlyHttpPOC
{
    ...
    public GhostlyHttpPOC(string supabaseUrl, string supabaseKey)
    {
        ...
        _jsonOptions = new JsonSerializerOptions
        {
            ...
            Converters = { new SupabaseDateTimeConverter() }
        };
    }
